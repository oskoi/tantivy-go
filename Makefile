...
build-verify:
	...
	CGO_ENABLED="1" gomobile bind -tags tantivylocal -v -target=android -androidapi 26 -o lib.aar github.com/oskoi/tantivy-go/gomobile
	CGO_ENABLED="1" gomobile bind -tags tantivylocal -v -target=ios -o Lib.xcframework github.com/oskoi/tantivy-go/gomobile
